...
async function main() {
  console.log("🚀 Bắt đầu deploy Task System lên Sei Mainnet...");
  ...
  // Xác nhận deploy
  console.log("\n⚠️  Bạn đang deploy Task System lên SEI MAINNET!");
  ...
  // Lưu vào file
  const deploymentPath = `./deployed/contract-addresses-task-only-seimainnet.json`;
  ...
  console.log("\n🎉 Deploy Task System lên Sei Mainnet hoàn tất thành công!");
