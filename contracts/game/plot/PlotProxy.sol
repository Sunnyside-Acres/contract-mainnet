 ...
 * @title PlotProxy
 * @author RYG.Labs
 * @notice Proxy contract for the Plot system using delegatecall pattern
...
contract PlotProxy {
    ...
    /// @notice Mapping from owner and plot ID to plot index
    mapping(address => mapping(uint256 => uint256)) public ownerPlotIndices;
